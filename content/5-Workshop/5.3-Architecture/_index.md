...
This student-created diagram is the submitted architecture design, not evidence of live resource state. Actual state is validated through console/CLI results and project screenshots.
